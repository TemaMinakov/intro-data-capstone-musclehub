...
print('\nTwo different people have tha same e-mail?')
...
member_pivot = just_apps_group.pivot(columns = 'is_member',
                            index = 'ab_test_group',
                            values = 'first_name').reset_index()
member_pivot['Total'] = member_pivot['Member'] + member_pivot['Not Member']
member_pivot['Percent Members'] = member_pivot['Member']/member_pivot['Total']*100
member_pivot
...
final_member_pivot['Percent Members'] = final_member_pivot['Member']/final_member_pivot['Total']*100
final_member_pivot
...
plt.bar(range(len(member_pivot)),member_pivot['Percent Members'])
...
plt.bar(range(len(final_member_pivot)),final_member_pivot['Percent Members'])
